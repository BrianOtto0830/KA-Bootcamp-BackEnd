...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | TrendEraAdmin - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page TrendEraAdmin Dashboard Template",
  // other metadata
};
