...
export const metadata: Metadata = {
  title: "Next.js Profile | TrendEraAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for TrendEraAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
